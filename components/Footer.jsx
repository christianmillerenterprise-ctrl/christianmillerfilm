...
export default function Footer() {
  ...
  return (
    <footer className="relative z-40 mt-32 border-t border-gold/25 bg-gradient-to-b from-paper via-depth to-[#d8ccbb] shadow-[inset_0_1px_0_rgba(253,252,248,0.55)]">
      <div className="max-w-6xl mx-auto px-6 md:px-10 py-14 md:py-20 grid md:grid-cols-3 gap-10">
        <div>
      ...
      <div className="max-w-6xl mx-auto px-6 md:px-10 pb-10 flex flex-col md:flex-row justify-between text-ink/50 text-sm">
